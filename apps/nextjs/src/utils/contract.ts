import { createPublicClient, createWalletClient, http, parseEther, formatEther, encodeFunctionData, decodeFunctionResult, type Address, type PublicClient, type WalletClient } from 'viem';
